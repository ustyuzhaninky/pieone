...
class Event:
    ...
    def update(self, node: str, command: str, time: int) -> None:
        ...
        elif (self.node.lower() == node.lower()) & (
             self.command.lower() == command.lower()):
            self.timing = time
            self.is_solved = True
            self.answer = EventManager().choises[
                EventManager().commands.index([node, command])]
        else:
            self.timing = time
            self.is_solved = False
            self.answer = EventManager().choises[
        ...
        self.tertiary_text += str(
            self.timing) + EventManager().time_measure_text
        ...
        self.events = [
            Event(
                ...
                resource_find(
                    ...
                    "images\\simulator_screen\\reactor_1.gif")
            ),
            Event(
            ...
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets\\"
                    "images\\simulator_screen\\furnace.gif")
            ),
            Event(
                ...
                resource_find(
                    ...
                    "assets\\images\\simulator_screen\\furnace.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\pump_1.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\"
                    "assets\\images\\simulator_screen\\pump_1.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets\\"
                    "images\\simulator_screen\\CO_1_high_level.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\CO_1_low_level.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets\\"
                    "images\\simulator_screen\\CO_2_high_level.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets\\"
                    "images\\simulator_screen\\CO_2_low_level.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\compressor_1.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\compressor_2.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\pump_2.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\vent_1.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\vent_2.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\vent_3.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\reactor_2.gif")
            ),
            Event(
            ...
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\tower_1.gif")
            ),
            Event(
            ...
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen"
                    "\\separator_1_high_pressure.gif")
            ),
            Event(
            ...
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\vessel_1_high_pressure.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\separator_1_low_level.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\separator_1_overflow.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\separator_2_overflow.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\separator_2_low_level.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\vessel_1_low_level.gif")
            ),
            Event(
                ...
                resource_find(
                    f"{os.environ['PIEONE_ROOT']}\\assets"
                    "\\images\\simulator_screen\\vessel_1_overflow.gif")
            )
        ]
